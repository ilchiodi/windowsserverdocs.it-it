...
![Screenshot che mostra la App nella schermata di blocco](../media/winlogon-automatic-restart-sign-on-arso/GTR_ADDS_LockScreen.gif)  
...
![Screenshot che mostra l'impostazione di criteri controlli dell'interfaccia utente in cui è possibile specificare se un dispositivo verrà automaticamente accesso aggiuntivo l'ultimo utente interattivo dopo il riavvio di Windows Update il sistema](../media/winlogon-automatic-restart-sign-on-arso/GTR_ADDS_SignInPolicy.gif)  

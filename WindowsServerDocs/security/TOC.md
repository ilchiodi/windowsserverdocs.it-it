...
## [Applicazione del Regolamento generale sulla protezione dei dati (RGPD) per Windows Server 2016](gdpr/gdpr-winserver-whitepaper.md)
...
### [Pianificare](guarded-fabric-shielded-vm/guarded-fabric-plan-overview.md)
#### [Pianificare servizi di hosting](guarded-fabric-shielded-vm/guarded-fabric-planning-for-hosters.md)
...
#### [Pianificare tenant](guarded-fabric-shielded-vm/guarded-fabric-shielded-vm-planning-for-tenants.md)
### [Distribuire](guarded-fabric-shielded-vm/guarded-fabric-deploying-hgs-overview.md)
...
###### [Modalità di TPM](guarded-fabric-shielded-vm/guarded-fabric-initialize-hgs-tpm-mode.md)
...
####### [Installare i certificati radice di TPM](guarded-fabric-shielded-vm/guarded-fabric-install-trusted-tpm-root-certificates.md)
...
##### [Modalità di TPM](guarded-fabric-shielded-vm/guarded-fabric-tpm-trusted-attestation-capturing-hardware.md)
...
### [Gestire](guarded-fabric-shielded-vm/guarded-fabric-manage-overview.md)
#### [Gestire il servizio Sorveglianza host](guarded-fabric-shielded-vm/guarded-fabric-manage-hgs.md)
#### [Considerazioni sulla succursale](guarded-fabric-shielded-vm/guarded-fabric-manage-branch-office.md)
...
### [Risolvere problemi](guarded-fabric-shielded-vm/guarded-fabric-troubleshoot-overview.md)
...
## [Attestazione dell'integrità del dispositivo](device-health-attestation.md)
...
### [Protect Remote Desktop credentials with Remote Credential Guard (Proteggere le credenziali di Desktop remoto con Credential Guard remoto)](https://technet.microsoft.com/itpro/windows/keep-secure/remote-credential-guard)
...
### [Documentazione tecnica sul Security Support Provider Schannel](tls/schannel-security-support-provider-technical-reference.md)
#### [Protocollo di sicurezza del livello trasporto](tls/transport-layer-security-protocol.md)
#### [Protocollo di sicurezza del livello trasporto Datagram](tls/datagram-transport-layer-security-protocol.md)

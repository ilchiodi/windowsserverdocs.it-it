...
<div class="container">
<h1>Documentazione di Windows Server</h1>
<h3>Windows Server è la piattaforma per la creazione di un'infrastruttura di applicazioni, reti e servizi Web collegati, dal gruppo di lavoro al data center</h3>
<p> </p>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Configurazione iniziale di<br>Windows Server 2019</h2>
                                            <p>Parti da qui per Windows Server 2019</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Aggiornamento a Windows Server 2019</h2>
                                            <p>Visita il centro aggiornamenti di Windows Server per istruzioni dettagliate sull'aggiornamento di Windows Server</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Gestisci Windows Server 2012 e le versioni più recenti con Windows Admin Center</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Infrastruttura iperconvergente</h2>
                                            <p>Consolida le funzionalità di calcolo, archiviazione e rete software-defined in un unico cluster</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Configurazione iniziale di<br>Windows Server 2016</h2>
                                            <p>Parti da qui per Windows Server 2016</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Fine del supporto per<br> Windows Server 2008 R2 e Windows Server 2008</h2>
                                            <p>Preparati per la fine del supporto esteso prevista per il 14 gennaio 2020</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Identità | Accesso</h2>
                                            <p>Proteggere le risorse aziendali da pirati informatici e attacchi alle identità controllando la sicurezza degli accessi con Active Directory, un prodotto di comprovato successo nel settore.</p>
<table>
     <tr>
       ...
       <hr width="80%">
        ...
        <td style="vertical-align: top;">
            ...
            <ol>
            <li>1. <a href="https://docs.microsoft.com/windows-server/identity/securing-privileged-access/privileged-access-workstations">Workstation con accesso con privilegi</a></li>
       <hr width="80%">
            <li>2. <a href="https://docs.microsoft.com/windows-server/identity/securing-privileged-access/securing-privileged-access-reference-material">Materiale di riferimento per la protezione dell'accesso con privilegi</a></li>
       <hr width="80%">
            <li>3. <a href="https://docs.microsoft.com/windows-server/identity/solution-guides/dynamic-access-control--scenario-overview">Controllo dinamico degli accessi: Panoramica dello scenario</a></li>
            </ol>
        </td>
    </tr>
</table></a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Clustering di failover</h2> 
                                            <p>Combinare singoli server in gruppi con il clustering di failover per aumentare la tolleranza di errore e la disponibilità dei sistemi che ospitano app e servizi strategici per l'azienda.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>I più votati</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Management</h2>
                                            <p>Gestire i sistemi e gli ambienti Windows Server, raccogliere informazioni sugli inventari hardware e software, ottimizzare i server per ottenere prestazioni migliori e automatizzare l'amministrazione per una maggiore efficienza.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>I più votati</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Rete</h2>
                                            <p>Connettere computer e sistemi ai fini della sicurezza, delle prestazioni, della qualità del servizio e della disponibilità con tecnologie fondamentali come <a href="https://docs.microsoft.com/windows-server/networking/dns/dns-top">DNS</a> e <a href="https://docs.microsoft.com/windows-server/networking/technologies/dhcp/dhcp-top">DHCP</a> oppure virtualizza la connettività con <a href="https://docs.microsoft.com/windows-server/networking/sdn/software-defined-networking">SDN (Software Defined Networking)</a>.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>I più votati</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Telecomando</h2>
                                            <p>Accedere a computer e dispositivi e controllarli in modalità remota per estendere la disponibilità aziendale ovunque e in qualsiasi momento con tecnologie come Servizi Desktop remoto, Accesso remoto e Strumenti di amministrazione remota del server.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>I più votati</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Sicurezza | Controllo</h2> 
                                            <p>Proteggere i data center che eseguono Windows Server come una macchina virtuale in qualsiasi cloud e limitare il rischio che utenti malintenzionati possano compromettere le credenziali e avviare malware senza essere rilevati nella rete con tecnologie quali macchine virtuali schermate, Device Guard, Credential Guard e Windows Defender.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>I più votati</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Archiviazione</h2>
                                            <p>Sfruttare le opzioni di archiviazione resilienti, a prestazioni elevate e convenienti che consentono la scalabilità a più petabyte, tra cui l'infrastruttura iperconvergente con archiviazione software-defined, il servizio di migrazione archiviazione e altre tecnologie.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>I più votati</u></h4>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Imparare a risolvere i problemi relativi ad alcune delle tecnologie e funzionalità più usate di Windows Server.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>I più votati</u></h4>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Virtualizzazione</h2>
                                             <p>Microsoft Hyper-V, la base di virtualizzazione per Windows Server, offre la virtualizzazione del calcolo per l'infrastruttura cloud e le app moderne, inclusi i contenitori, gli aggiornamenti in sequenza del cluster, le macchine virtuali schermate e altre funzionalità di sicurezza avanzata.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>I più votati</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Windows Server 2008 e<br> Windows Server 2008 R2</h3>
                                            <p></p>
                                            </div>
                                    </div>
                                </div>

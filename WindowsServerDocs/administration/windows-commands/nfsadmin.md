...
**\-u** *UserName*  
Specifica il nome utente dell'utente le cui credenziali devono essere utilizzati. Potrebbe essere necessario aggiungere il nome di dominio per il nome utente nel formato *domain***\\***UserName*  

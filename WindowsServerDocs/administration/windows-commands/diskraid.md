---
title: diskraid
description: Windows Commands (comandi di Windows) per DiskRAID, che è uno strumento da riga di comando che consente di configurare e gestire la matrice ridondante di sottosistemi di archiviazione (RAID) di dischi indipendenti (o convenienti).
...
### <a name="detail"></a><a name=BKMK_8></a>dettaglio
...
È necessario specificare il parametro *size* o l'unità \<>. Possono anche essere usati insieme.
...
### <a name="login"></a><a name=BKMK_20></a>accesso
...
### <a name="name"></a><a name=BKMK_23></a>nome
...
Specifica il tipo di oggetto da selezionare. Il tipo di > oggetto \<può essere **provider**, **sottosistema**, **controller**, **unità**o **lun**.
...
Specifica il numero dell'oggetto \<> da selezionare. Se il <object number> specificato non è valido, vengono cancellate tutte le selezioni esistenti per gli oggetti del tipo specificato. Se non viene specificato alcun <object number>, viene visualizzato l'oggetto corrente.

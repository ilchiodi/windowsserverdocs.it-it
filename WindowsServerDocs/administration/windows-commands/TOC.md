# [Comandi di Windows](windows-commands.md)
## [Indicazioni generali sulla sintassi della riga di comando](command-line-syntax-key.md)
## [Comandi in base al ruolo del server](commands-by-server-role.md)
...
### [Riferimenti ai comandi di Windows Server Backup](windows-server-backup-command-reference.md)
### [append](append.md)
### [arp](arp.md)
### [assoc](assoc.md)
### [at](at.md)
...
#### [Bitsadmin esempi](bitsadmin-examples.md)
#### [bitsadmin addfile](bitsadmin-addfile.md)
#### [bitsadmin addfileset](bitsadmin-addfileset.md)
#### [bitsadmin addfilewithranges](bitsadmin-addfilewithranges.md)
#### [Bitsadmin cache](bitsadmin-cache.md)
##### [bitsadmin cache ed Elimina](bitsadmin-cache-and-delete.md)
##### [DeleteUrl e bitsadmin cache](bitsadmin-cache-and-deleteurl.md)
##### [getexpirationtime e bitsadmin cache](bitsadmin-cache-and-getexpirationtime.md)
##### [getlimit e bitsadmin cache](bitsadmin-cache-and-getlimit.md)
##### [Guida e bitsadmin cache](bitsadmin-cache-and-help.md)
##### [informazioni e bitsadmin cache](bitsadmin-cache-and-info.md)
##### [elenco e bitsadmin cache](bitsadmin-cache-and-list.md)
##### [setexpirationtime e bitsadmin cache](bitsadmin-cache-and-setexpirationtime.md)
##### [setlimit e bitsadmin cache](bitsadmin-cache-and-setlimit.md)
##### [Cancella e bitsadmin cache](bitsadmin-cache-clear.md)
...
#### [Bitsadmin peer caching di BITS](bitsadmin-peercaching.md)
##### [getconfigurationflags e bitsadmin peer caching di BITS](bitsadmin-peercaching-and-getconfigurationflags.md)
##### [Guida e bitsadmin peer caching di BITS](bitsadmin-peercaching-and-help.md)
##### [setconfigurationflags e bitsadmin peer caching di BITS](bitsadmin-peercaching-and-setconfigurationflags.md)
#### [Bitsadmin peer](bitsadmin-peers.md)
##### [Bitsadmin peer e chiaro](bitsadmin-peers-and-clear.md)
##### [Bitsadmin peer e scoprire](bitsadmin-peers-and-discover.md)
##### [Bitsadmin peer e della Guida](bitsadmin-peers-and-help.md)
##### [Bitsadmin peer ed elenco](bitsadmin-peers-and-list.md)
...
#### [Bitsadmin trasferimento](bitsadmin-transfer.md)
#### [bitsadmin util](bitsadmin-util.md)
##### [enableanalyticchannel e bitsadmin util](bitsadmin-util-and-enableanalyticchannel.md)
##### [GETIEPROXY e bitsadmin util](bitsadmin-util-and-getieproxy.md)
##### [Guida e bitsadmin util](bitsadmin-util-and-help.md)
##### [REPAIRSERVICE e bitsadmin util](bitsadmin-util-and-repairservice.md)
##### [SETIEPROXY e bitsadmin util](bitsadmin-util-and-setieproxy.md)
##### [versione e bitsadmin util](bitsadmin-util-and-version.md)
...
#### [nslookup set dominio](nslookup-set-domain.md)

...
|/FS: {FAT|FAT32|NTFS|UDF}|Specifica il tipo di file system: File system FAT, FAT32, NTFS o funzione definita dall'utente. I dischi floppy possono usare solo il file system FAT.|
...
-   **Formato** messaggi
    ...
    Al termine, formattazione **formato** vengono visualizzati messaggi che mostrano lo spazio su disco totale, gli spazi contrassegnati come danneggiato e lo spazio disponibile per i file.
...
[Chiave sintassi della riga di comando](https://technet.microsoft.com/library/cc771080.aspx)
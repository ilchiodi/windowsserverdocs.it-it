...
|Chiave|Definizione|Valore|Esempio|
|---|----------|-----|-------|
...
|    *continuare*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                        *continua* = UPN =User@Domain.com&                                                                                                                                                                                                                                                                                                                                                                                                         |
...
## <a name="certreq--enroll"></a><a name=BKMK_enroll></a>Certreq-registrazione
...
## <a name="options"></a><a name=BKMK_Options></a>Opzioni

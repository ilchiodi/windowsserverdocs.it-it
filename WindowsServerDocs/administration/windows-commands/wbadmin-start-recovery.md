...
description: Argomento di riferimento per Wbadmin start Recovery, che esegue un'operazione di ripristino in base ai parametri specificati.
...
|---------|-----------|
|-version|Specifica l'identificatore di versione del backup da ripristinare in MM/GG/AAAA-formato hh: mm. Se non si conosce l'identificatore di versione, digitare **wbadmin ottenere versioni**.|
...
```
Per eseguire un ripristino del backup dal 31 marzo 2013, eseguito alle 9:00 del volume \\ \\? \Volume{cc566d14-44a0-11d9-9d93-806e6f6e6963}\, tipo:
```

...
```
Nell'esempio seguente viene illustrato l'utilizzo di * * le protezioni con * * comando per disabilitare la protezione necessario riavviare il computer dispone di 3 volte.
```

...
Per aggiornare la new_alert dell'agente di raccolta dati esistente, impostare il valore soglia per il contatore% tempo processore nel gruppo di contatori processore (_Total) su 40%.  
```  

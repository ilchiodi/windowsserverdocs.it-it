...
description: Argomento di riferimento per sottocomando set-Device, che modifica gli attributi di un computer pre-installazione.
...
della sintassi della riga di comando usando il comando[Add-Device](using-the-add-device-command.md)
[usando il comando Get-AllDevices](using-the-get-alldevices-command.md)
[usando il comando Get-Device](using-the-get-device-command.md)

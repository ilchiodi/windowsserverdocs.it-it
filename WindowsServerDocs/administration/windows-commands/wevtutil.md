...
|   /p:\<Password>   |                                                                                                                                               Specifica la password per l'utente. Se il **/u** viene usata l'opzione e questa opzione non è specificata o \<Password > è " *", l'utente verrà richiesto di immettere una password. Questa opzione è applicabile solo quando la \* \*/u* \* opzione specificata.                                                                                                                                                |

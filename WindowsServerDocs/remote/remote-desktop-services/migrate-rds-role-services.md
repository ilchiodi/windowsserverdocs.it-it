...
- [Eseguire la migrazione di Gestore connessione desktop remoto](#migrate-rdconnection-broker-servers)
...
- [Eseguire la migrazione di server Accesso Web desktop remoto](#migrate-rdweb-access-servers)

- [Eseguire la migrazione di server Gateway Desktop remoto](#migrate-rdgateway-servers)

- [Eseguire la migrazione di server licenze Desktop remoto](#migrate-rdgateway-servers)
...
> [!IMPORTANT]
> Eseguire la migrazione di insiemi di sessioni solo dopo aver completato il passaggio precedente, [eseguire la migrazione di Gestore connessione desktop remoto](#migrate-rdconnection-broker-servers).
...
> [!IMPORTANT]
> Eseguire la migrazione di insiemi di desktop virtuali solo dopo aver completato il passaggio precedente, [eseguire la migrazione di Gestore connessione desktop remoto](#migrate-rdconnection-broker-servers).

...
### [Introduzione al client Desktop remoto in Windows](clients/windows.md)
### [Novità del client di Windows](clients/windows-whatsnew.md)
### [Introduzione al client Desktop remoto in Android](clients/remote-desktop-android.md)
### [Novità del client Android](clients/android-whatsnew.md)
### [Introduzione al client Desktop remoto in iOS](clients/remote-desktop-ios.md)
### [Novità del client iOS](clients/ios-whatsnew.md)
### [Introduzione al client Desktop remoto su Mac](clients/remote-desktop-mac.md)

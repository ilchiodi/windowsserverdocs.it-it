...
Per reimpostare tutte le impostazioni del client Web a livello di distribuzione sulle configurazioni predefinite, esegui il cmdlet di PowerShell seguente:

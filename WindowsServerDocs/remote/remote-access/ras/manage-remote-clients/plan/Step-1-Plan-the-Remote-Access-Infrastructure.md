...
Se un oggetto Criteri di gruppo in un server Accesso remoto, client o server applicazioni è stato eliminato per errore, verrà visualizzato il messaggio di errore seguente: **Oggetto Criteri di gruppo <GPO name> nebyla nalezena**.  

...
## <a name="enable-clients-from-forest2-to-connect-via-directaccess"></a><a name="EnableForest2DA"></a>Consentire ai client di Foresta2 di connettersi tramite DirectAccess  

...
1.  Identificare la topologia delle schede di rete da usare. Accesso remoto può essere impostato con una delle seguenti topologie:  
    ...
    -   Con due schede di rete-sia nella periferia con una scheda di rete connessa a Internet e l'altra alla rete interna o dietro un NAT, firewall o un dispositivo di router, con una scheda di rete connesse a una rete perimetrale e l'altra alla classe interna rete.  
  
    -   Dietro un dispositivo NAT con una scheda di rete-server di accesso remoto viene installato dietro un dispositivo NAT e l'unica scheda di rete è connessa alla rete interna.  
...
#### <a name="bkmk_website_cert_IPHTTPS"></a>Pianificare i certificati per IP-HTTPS  

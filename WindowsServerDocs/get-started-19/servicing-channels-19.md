...
description: 'Spiegazione dei canali di manutenzione di Windows Server: LTSC e SAC'
...
ms.locfileid: "9149767"
---
# Canali di manutenzione di Windows Server: LTSC e SAC
...
## Canale semestrale 
Il canale semestrale è ideale per i clienti che innovano rapidamente per usufruire dei vantaggi delle nuove funzionalità del sistema operativo in modo rapido, sia nelle applicazioni, in particolare quelle basate su contenitori e micro servizi, sia nei datacenter ibridi definiti dal software. Per i prodotti Windows Server in Canale semestrale saranno disponibili nuovi rilasci due volte l'anno, in primavera e in autunno. Ogni versione rilasciata in questo canale verrà supportata per 18 mesi a partire dal rilascio iniziale.
...
## Devi mantenere i server nel canale LTSC o spostarli nel Canale semestrale?
...
- **Windows Update (autonomo)**: questa opzione è disponibile solo per i server connessi a Internet e in cui Windows Update è abilitato.
...
- **System Center Configuration Manager** offre il massimo controllo sulla manutenzione. I professionisti IT possono rinviare gli aggiornamenti o approvarli e hanno a disposizione più opzioni per decidere la destinazione delle distribuzioni e gestire l'utilizzo della larghezza di banda e i tempi di distribuzione.
...
## Ottenere le versioni di anteprima tramite il Programma Windows Insider
...
## Per identificare Windows Server 2019 e Windows Server, versione 1809
...
**Esempio di Windows Server, versione 1809 (SAC) Standard Edition Server Core:**
...
# Argomenti correlati
[Modifiche apportate a Nano Server in Windows Server Canale semestrale](../get-started/nano-in-semi-annual-channel.md)

[Ciclo di vita del supporto di Windows Server](https://support.microsoft.com/lifecycle)

[Determinare se il Server Core è in esecuzione](https://msdn.microsoft.com/library/hh846315%28v=vs.85%29.aspx?f=255&MSPPError=-2147217396)

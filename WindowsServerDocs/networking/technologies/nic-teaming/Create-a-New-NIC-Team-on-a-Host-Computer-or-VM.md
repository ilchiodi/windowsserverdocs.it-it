...
7.  Nella console di gestione Hyper-V in **macchine virtuali**, fare doppio clic su macchina virtuale che si desidera configurare e quindi fare clic su **impostazioni**.  

   La macchina virtuale **impostazioni** verrà visualizzata la finestra di dialogo.
...
13. Per aggiungere una seconda scheda di rete, nella console di gestione Hyper-V **macchine virtuali**, fare doppio clic su nella stessa macchina virtuale e quindi fare clic su **impostazioni**.  
...
2. Nel **delle proprietà** riquadro, nella prima colonna, individuare **NIC Teaming**e quindi fare clic sui **disabilitato** collegamento.  

   Il **NIC Teaming** verrà visualizzata la finestra di dialogo.
...
4. Fare clic su **attività**, fare clic su **aggiungere al nuovo Team**.  

   Il **nuovo team** nella finestra di dialogo apre e visualizza le schede di rete e i membri del team.
...
7. Se si desidera configurare il nome dell'interfaccia gruppo primaria o assegnare un numero di VLAN per il gruppo NIC, fare clic sul collegamento a destra della **interfaccia gruppo primaria**.  

    Il **nuova interfaccia team** verrà visualizzata la finestra di dialogo.

...
## <a name="branchcache-modes"></a><a name="BKMK_2"></a>Modalità BranchCache
...
## <a name="branchcache-processes-locate-content"></a><a name="BKMK_9"></a>Processi di BranchCache: individuazione del contenuto

...
## [Novità di Reti](What-s-New-in-Networking.md)
...
##### [Pianificazione della distribuzione del certificato server](core-network-guide/cncg/server-certs/Server-Certificate-Deployment-Planning.md)
##### [Distribuzione del certificato server](core-network-guide/cncg/server-certs/Server-Certificate-Deployment.md)
...
###### [Configurare WEB1 per distribuire gli elenchi di revoche di certificati (CRL)](core-network-guide/cncg/server-certs/Configure-WEB1-to-Distribute-Certificate-Revocation-lists.md)
...
###### [Verificare la registrazione dei server di un certificato server](core-network-guide/cncg/server-certs/verify-Server-Enrollment-of-a-Server-Certificate.md)
#### [Distribuire l'accesso wireless autenticato con 802.1X basato su password](core-network-guide/cncg/wireless/a-deploy-8021X-wireless-access.md)
...
#### [Distribuire la modalità cache ospitata di BranchCache](core-network-guide/cncg/bc-hcm/1-Deploy-Bc-Hcm.md)
##### [Panoramica della distribuzione in modalità cache ospitata di BranchCache](core-network-guide/cncg/bc-hcm/2-Bc-Hcm-Deploy-Overview.md)
##### [Pianificazione della distribuzione in modalità cache ospitata di BranchCache](core-network-guide/cncg/bc-hcm/3-Bc-Hcm-Plan.md)
##### [Distribuzione in modalità cache ospitata di BranchCache](core-network-guide/cncg/bc-hcm/4-Bc-Hcm-Deployment.md)
###### [Installare la funzionalità BranchCache e configurare il server della cache ospitata dal punto di connessione del servizio](core-network-guide/cncg/bc-hcm/5-Bc-Feature-Scp.md)
...
###### [Configurare l'individuazione client automatica della cache ospitata dal punto di connessione del servizio](core-network-guide/cncg/bc-hcm/10-Bc-Client-By-Scp.md)
...
######## [Abilitare la pubblicazione di hash per file server appartenenti al dominio](branchcache/deploy/Enable-Hash-Publication-for-Domain-Member-File-Servers.md)
...
###### [Utilizzare Criteri di gruppo per configurare i computer client appartenenti al dominio](branchcache/deploy/Use-Group-Policy-to-Configure-Domain-Member-Client-computers.md)
...
####### [Configurare le regole del firewall per i membri non appartenenti al dominio per consentire il traffico BranchCache](branchcache/deploy/Configure-Firewall-Rules-for-Non-Domain-Members-to-Allow-BranchCache-Traffic.md)
...
#### [Risposte DNS basate sull'ora del giorno con un server app cloud Azure](dns/deploy/dns-tod-azure-cloud-app-server.md)
...
### [Anteprima di Insider](technologies/hpn/hpn-insider-preview.md)
...
#### [Controllo dell'accesso basato sui ruoli](technologies/ipam/Role-based-Access-Control.md)
##### [Gestire il controllo dell'accesso basato sui ruoli con Server Manager](technologies/ipam/Manage-Role-Based-Access-Control-with-server-manager.md)
###### [Creare un ruolo utente per il controllo dell'accesso](technologies/ipam/create-a-User-Role-for-Access-Control.md)
...
##### [Gestire il controllo degli accessi basato sui ruoli con Windows PowerShell](technologies/ipam/Manage-Role-Based-Access-Control-with-Windows-powershell.md)
...
#### [Pianificare Server dei criteri di rete come server RADIUS](technologies/nps/nps-plan-server.md)
#### [Pianificare Server dei criteri di rete come proxy RADIUS](technologies/nps/nps-plan-proxy.md)
### [Distribuzione di Server dei criteri di rete](technologies/nps/nps-deploy.md)
...
#### [Configurare firewall per il traffico RADIUS](technologies/nps/nps-firewalls-configure.md)
...
#### [Gestire le connessioni di accesso alla rete](technologies/nps/nps-manage-servers.md)
##### [Configurare Server dei criteri di rete in un computer multihomed](technologies/nps/nps-multihomed-configure.md)
##### [Configurare le informazioni sulle porte UDP di Server dei criteri di rete](technologies/nps/nps-udp-ports-configure.md)
...
##### [Aumentare il numero di autenticazioni simultanee elaborate da Server dei criteri di rete](technologies/nps/nps-concurrent-auth.md)
...
#### [Gestire i modelli di Server dei criteri di rete](technologies/nps/nps-manage-templates.md)
...
### [Strumenti per le prestazioni per carichi di lavoro di rete](technologies/network-subsystem/net-sub-performance-tools.md)
...
## [Criteri della qualità del servizio (QoS)](technologies/qos/qos-policy-top.md)
...
##### [Installare il ruolo server di Controller di rete con Server Manager](sdn/technologies/network-controller/Install-the-Network-Controller-server-role-using-server-manager.md)
##### [Passaggi di post-distribuzione per Controller di rete](sdn/technologies/network-controller/post-deploy-steps-nc.md)
...
#### [Requisiti di installazione e preparazione per la distribuzione di controller di rete](sdn/plan/Installation-and-Preparation-Requirements-for-Deploying-Network-Controller.md)
...
##### [Creare, eliminare o aggiornare le reti virtuali tenant](sdn/manage/create,-delete,-or-Update-Tenant-Virtual-Networks.md)
##### [Aggiungere un gateway virtuale a una rete virtuale tenant](sdn/manage/add-a-Virtual-Gateway-to-a-Tenant-Virtual-Network.md)
...
##### [Configurare la codifica per una subnet virtuale](sdn/vnet-encryption/sdn-config-vnet-encryption.md)
##### [Misurazione in uscita in una rete virtuale](sdn/manage/sdn-egress.md)

#### [Gestisci i carichi di lavoro del tenant](sdn/manage/Manage-Tenant-Workloads.md)
##### [Creare una macchina virtuale e connettersi a una rete virtuale tenant o VLAN](sdn/manage/create-a-Tenant-VM.md)
...
##### [Configurare il servizio di bilanciamento del carico software per bilanciamento del carico e Network Address Translation](sdn/manage/Configure-SLB-and-Nat.md)
...
#### [Configura il peering della rete virtuale](sdn/vnet-peering/sdn-configure-vnet-peering.md)
...
### [Insider Preview - Servizio Ora di Windows in Windows Server 2019](windows-time-service/insider-preview.md)

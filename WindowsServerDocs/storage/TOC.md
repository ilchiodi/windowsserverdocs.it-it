...
### [Novità nella deduplicazione dati](data-deduplication/whats-new.md)
### [Comprendere la deduplicazione dati](data-deduplication/understand.md)
...
### [Utilizzare robocopy per eseguire il preseeding dei file per la replica DFS](dfs-replication/preseed-dfsr-with-robocopy.md)
...
#### [Configurare lo screening dei file](fsrm/configure-file-screen-audit.md)
...
#### [Modificare le proprietà dei modelli di screening dei file](fsrm/edit-file-screen-template-properties.md)
...
### [Attività di gestione dei file](fsrm/file-management-tasks.md)
...
### [Stati di integrità e operativo](storage-spaces/storage-spaces-states.md)
...
#### [Cluster di macchina virtuale guest](storage-spaces/storage-spaces-direct-in-vm.md)
...
#### [Eseguire l'aggiornamento di un cluster di spazi di archiviazione diretta a Windows Server 2019](storage-spaces/upgrade-storage-spaces-direct-to-windows-server-2019.md)
### Gestisci
...
#### [Monitor con Monitoraggio di Azure](storage-spaces/configure-azure-monitor.md)
...
#### [Passaggio 2: Post-configurazione di ADFS](work-folders/deploy-work-folders-adfs-step2.md)

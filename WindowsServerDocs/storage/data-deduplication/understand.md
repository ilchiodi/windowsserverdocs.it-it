...
|------------|-----------------|------------------|
| <a id="usage-type-default"></a>Predefinita | File server per uso generale:<ul><li>Condivisioni del team</li><li>Cartelle di lavoro</li><li>Reindirizzamento cartelle</li><li>Condivisioni per lo sviluppo di software</li></ul> | <ul><li>Ottimizzazione in background</li><li>Criteri predefiniti di ottimizzazione:<ul><li>Età minima del file = 3 giorni</li><li>Ottimizzazione dei file in uso = No</li><li>Ottimizzazione dei file parziali = No</li></ul></li></ul> |

...
title: Impostazioni avanzate della deduplicazione dati
...
---
# <a name="advanced-data-deduplication-settings"></a>Impostazioni avanzate della deduplicazione dati
...
### <a id="modifying-job-schedules-change-schedule"></a>Modifica di una pianificazione della deduplicazione dei dati
...
## <a id="modifying-volume-settings"></a>Modifica delle impostazioni della deduplicazione dei dati a livello di volume
### <a id="modifying-volume-settings-how-to-toggle"></a>Attivazione e disattivazione delle impostazioni dei volumi
...
## <a id="modifying-dedup-system-settings"></a>Modifica delle impostazioni della deduplicazione dei dati a livello di sistema
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Questa impostazione consente di configurare l'intervallo in cui i processi di Garbage Collection normali diventano [processi di Garbage Collection completi](advanced-settings.md#faq-full-v-regular-gc). L'impostazione n significa che ogni n<sup>esimo</sup> processo è stato un processo Garbage Collection completo. Nota che un Garbage Collection completo è sempre disabilitato (indipendentemente dal valore del Registro di sistema) per i volumi con il [il tipo di utilizzo Backup](understand.md#usage-type-backup). `Start-DedupJob -Type GarbageCollection -Full` può essere utilizzato se si desidera un processo Garbage Collection completo su un volume Backup.</td>
            <td>Numeri interi (-1 indica disabilitato)</td>
            <td>Vedi [questa domanda nelle Domande frequenti](advanced-settings.md#faq-why-disable-full-gc)</td>
        </tr>
    </tbody>
</table>

## <a id="faq"></a>Domande frequenti
<a id="faq-use-responsibly"></a>**Dopo aver modificato un'impostazione di deduplicazione dei dati, i processi sono lenti o non terminano e le prestazioni del carico di lavoro sono peggiorate. Perché?**  
...
<a id="faq-running-dedup-jobs-manually"></a>**È possibile eseguire un processo di deduplicazione dei dati senza creare una nuova pianificazione?**  
Sì, [tutti i processi possono essere eseguiti manualmente](run.md#running-dedup-jobs-manually).

<a id="faq-full-v-regular-gc"></a>**Qual è la differenza tra processi normali e completi in Garbage Collection?**  
...
<a id="faq-why-disable-full-gc"></a>**Perché è meglio disattivare i processi di Garbage Collection completi?**  

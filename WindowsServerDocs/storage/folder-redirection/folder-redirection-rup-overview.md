...
1. Il sistema operativo Windows controlla le nuove impostazioni di Criteri di gruppo (**Scarica profili mobili solo nei computer primari** e **Reindirizza cartelle solo nei computer primari**) per determinare se l'attributo **msDS-Primary-computer** è attivo I servizi di dominio directory devono influenzare la decisione di eseguire il roaming del profilo dell'utente o applicare il reindirizzamento cartelle.

...
ms.locfileid: "8976727"
---
# Panoramica di Canale semestrale di Windows Server
...
**I clienti di Windows Server hanno a disposizione due canali di rilascio principali: Long-Term Servicing Channel e il nuovo Canale semestrale.** Puoi mantenere i server sul canale Long-Term Servicing Channel (LTSC), spostarli nel nuovo Canale semestrale o disporre di alcuni server in una delle tracce in base alle tue esigenze.
...
# Argomenti correlati
[Canali di manutenzione di Windows Server 2019: LTSC e SAC](https://docs.microsoft.com/windows-server/get-started-19/servicing-channels-19)

[Modifiche apportate al server Nano nel canale semestrale di Windows Server](nano-in-semi-annual-channel.md)

[Ciclo di vita del supporto di Windows Server](https://support.microsoft.com/en-us/lifecycle)

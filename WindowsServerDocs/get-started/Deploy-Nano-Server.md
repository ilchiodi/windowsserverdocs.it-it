...
9. A un prompt dei comandi con privilegi elevati, passare alla directory in cui si trova il disco rigido virtuale di Nano Server ed eseguire i comandi seguenti: **md mountdir**

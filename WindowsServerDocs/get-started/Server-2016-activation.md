...
ms.locfileid: "9150851"
---
# Attivazione di Windows Server 2016
...
>[!NOTE]
>**Nota:**  Per supportare l'attivazione di uno di questi client più recenti potrebbero essere necessari aggiornamenti sul server KMS. Se vengono visualizzati errori di attivazione, verifica che siano stati installati gli aggiornamenti appropriati elencati dopo questa tabella.
...
>- Le installazioni del Servizio di gestione delle chiavi in Windows Server 2012 devono essere aggiornate per supportare l'attivazione dei client che eseguono Windows 10 e Windows Server 2016 o sistemi operativi client o server più recenti. Per altre informazioni, vedi[luglio 2016 aggiornamento cumulativo per Windows Server 2012](https://support.microsoft.com/help/3172615/july-2016-update-rollup-for-windows-server-2012). 
>- Le installazioni del Servizio di gestione delle chiavi in Windows 8.1 o Windows Server 2012 R2 devono essere aggiornate per supportare l'attivazione dei client che eseguono Windows 10 e Windows Server 2016 o sistemi operativi client o server più recenti. Per altre informazioni, vedi[luglio 2016 aggiornamento cumulativo per Windows 8.1 e Windows Server 2012 R2](https://support.microsoft.com/help/3172614/july-2016-update-rollup-for-windows-8.1-and-windows-server-2012-r2).  
...
>[!NOTE] 
>Per richiedere questa eccezione, contatta il call center dell'attivazione. Per altre informazioni, vedi [Contratti multilicenza Microsoft]( https://www.microsoft.com/licensing).

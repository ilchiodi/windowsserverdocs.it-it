...
## <a name="option-3-apply-the-cumulative-update-to-an-existing-offline-vhd-or-vhdx"></a>Opzione 3: Applicare l'aggiornamento cumulativo esistente offline VHD o VHDX
...
## <a name="option-4-apply-the-cumulative-update-to-a-running-nano-server"></a>Opzione 4: Applicare l'aggiornamento cumulativo per un'esecuzione di Nano Server
...
## <a name="option-5-download-and-install-the-cumulative-update-to-a-running-nano-server"></a>Opzione 5: Scaricare e installare l'aggiornamento cumulativo di un Nano Server
...
- [Configurazione di Windows Update per WSUS](https://msdn.microsoft.com/en-us/library/dd939844(v=ws.10).aspx) impostando le seguenti chiavi del Registro di sistema:
  - WUServer
  - WUStatusServer (in genere utilizza lo stesso valore di WUServer)
  - UseWUServer
  - AUOptions
- [La gestione degli aggiornamenti dell'infrastruttura in VMM](https://technet.microsoft.com/library/gg675084(v=sc.12).aspx)
- [La registrazione di un'attività pianificata](https://technet.microsoft.com/library/jj649811.aspx)
...
ms.locfileid: "6121470"
---
# Aggiornamento di Nano Server
...
Nel caso dell'aggiornamento cumulativo per Windows Server 2016 del 26 settembre 2016 ([KB3192366](https://support.microsoft.com/en-us/kb/3192366)), devi prima installare l'aggiornamento dello stack di manutenzione più recente per Windows 10 versione 1607 del 23 agosto 2016 ([KB3176936](https://support.microsoft.com/en-us/kb/3176936)) come prerequisito. Per la maggior parte delle opzioni di seguito, devi usare i file MSU contenenti i pacchetti di aggiornamento CAB. Visita Microsoft Update Catalog per scaricare ognuno di questi pacchetti di aggiornamento:
...
## Opzione 1: integrare un aggiornamento cumulativo in una nuova immagine
...
## Opzione 2: integrare un aggiornamento cumulativo in un'immagine esistente
...
## Opzione 3: applicare l'aggiornamento cumulativo a un disco VHD o VHDX
...
## Opzione 4: applicare l'aggiornamento cumulativo a un'istanza di Nano Server in esecuzione
...
## Opzione 5: scaricare e installare l'aggiornamento cumulativo in un'istanza di Nano Server in esecuzione

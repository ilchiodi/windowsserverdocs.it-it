...
|------|---------|
|Impostazione predefinita in PAW<p>-   Windows Server Update Services<br />-   Windows Defender|-   Nessun costo aggiuntivo<br />-   Esecuzione delle funzioni di sicurezza di base necessarie<br />-   Istruzioni incluse in questo materiale sussidiario|
|Gestione con [Intune](https://technet.microsoft.com/library/jj676587.aspx)|<ul><li>Visibilità e controllo basati su cloud<p><ul><li>Distribuzione software</li><li>o   Gestione degli aggiornamenti software</li><li>Gestione dei criteri di Windows Firewall</li><li>Protezione antimalware</li><li>Assistenza remota</li><li>Gestione delle licenze software.</li></ul></li><li>Nessuna necessità di infrastruttura server</li><li>Necessità di eseguire la procedura "Abilitare la connettività a servizi cloud" della fase 2</li><li>Se il computer PAW non è stato aggiunto a un dominio, questo approccio richiede l'applicazione delle baseline SCM alle immagini locali tramite lo strumento disponibile con il download della baseline di sicurezza.</li></ul>|

...
|-|-|-|  
|**ID evento**|**Origine**|**Messaggio**|  
|**16654**|Directory-Services-SAM|Un pool di identificatori di account (RID) è stato invalidato. Questa situazione può verificarsi nei seguenti casi previsti:<br /><br />1. il backup viene ripristinato da un controller di dominio.<br /><br />2. un controller di dominio in esecuzione in una macchina virtuale viene ripristinato da uno snapshot.<br /><br />3. un amministratore ha invalidato manualmente il pool|  
...
|**1100**|Eventi di istanze di Servizi Web Active Directory|I valori specificati nella sezione <appsettings> del file di configurazione di Servizi Web Active Directory sono stati caricati senza errori.|  
|**1200**|Eventi di istanze di Servizi Web Active Directory|Servizi Web Active Directory: l'istanza di directory specificata viene servita.<br /><br />Istanza directory: NTDS<br /><br />Porta LDAP dell'istanza di directory: 389<br /><br />Porta SSL dell'istanza di directory: 636|  
...
|   **1314**   |    Replica DFS    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  Servizio Replica DFS: i file registro di debug sono stati configurati<br /><br />Ulteriori informazioni:<br /><br />Percorso del file di log di debug: C:\Windows\debug                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
#### <a name="BKMK_TshhotSafeRestore"></a>Metodologia generale per la risoluzione dei problemi relativi al ripristino sicuro del controller di dominio  
...
|        **Origine**        |                                                                                                                                                                                                                                                                                      Microsoft-Windows-ActiveDirectory_DomainService                                                                                                                                                                                                                                                                                      |
|       **Gravità**       |                                                                                                                                                                                                                                                                                                       Informativo                                                                                                                                                                                                                                                                                                       |
|       **Messaggio**        | *<COMPUTERNAME>* impostare i seguenti valori del registro di sistema per inizializzare la replica SYSVOL durante un ripristino non autorevole:<br /><br />Chiave del Registro di sistema:%1<br /><br />Valore del Registro di sistema: %2<br /><br />Dati del valore del Registro di sistema: %3<br /><br />Active Directory ha rilevato che la macchina virtuale che ospita il controller di dominio è stata ripristinata a uno stato precedente. *<COMPUTERNAME>* necessario inizializzare un ripristino non autorevole per la replica SYSVOL locale. L'operazione viene eseguita arrestando il servizio FRS o DFSR usato per replicare la cartella SYSVOL e avviandolo con i valori e le chiavi del Registro di sistema appropriati per attivare il ripristino. |
| **Note e risoluzione** |                                                                                                                                                                                                                                                    Si tratta di un evento previsto quando si ripristina uno snapshot. Tutti i dati SYSVOL presenti nel controller di dominio vengono sostituiti con una copia del controller di dominio del partner.                                                                                                                                                                                                                                                    |
...
|        **Origine**        |                                                                                                                                                                                                                                                                                                                                                                                                          Microsoft-Windows-ActiveDirectory_DomainService                                                                                                                                                                                                                                                                                                                                                                                                           |
|       **Gravità**       |                                                                                                                                                                                                                                                                                                                                                                                                                               Errore                                                                                                                                                                                                                                                                                                                                                                                                                                |
|       **Messaggio**        | *<COMPUTERNAME>* non è riuscito a impostare i seguenti valori del registro di sistema per inizializzare la replica SYSVOL durante un ripristino non autorevole:<br /><br />Chiave del Registro di sistema:%1<br /><br />Valore del Registro di sistema: %2<br /><br />Dati del valore del Registro di sistema: %3<br /><br />Codice errore: %4<br /><br />Messaggio di errore: %5<br /><br />Active Directory ha rilevato che la macchina virtuale che ospita il controller di dominio è stata ripristinata a uno stato precedente. *<COMPUTERNAME>* necessario inizializzare un ripristino non autorevole per la replica SYSVOL locale. L'operazione viene eseguita arrestando il servizio FRS o DFSR usato per replicare la cartella SYSVOL e avviandolo con i valori e le chiavi del Registro di sistema appropriati per attivare il ripristino. *<COMPUTERNAME>* non è riuscito a impostare i valori del registro di sistema precedenti e non è possibile completare il ripristino non autorevole. Esegui il ripristino non autorevole manualmente. |
...
|        **Origine**        |                                                                             Microsoft-Windows-ActiveDirectory_DomainService                                                                             |
|       **Gravità**       |                                                                                                  ERRORE                                                                                                  |
|       **Messaggio**        | *<COMPUTERNAME>* non è riuscito a invalidare il pool RID corrente dopo il ripristino dello stato precedente del controller di dominio virtuale.<br /><br />Dati aggiuntivi.<br /><br />Codice di errore: %1<br /><br />Valore errore: %2 |
...
|--------------|-------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **ID evento** |       **Origine**        |                                                                                                                                                                                                       **Messaggio**                                                                                                                                                                                                       |
|    **1**     |     Kernel-General      |                                                                                                                                   L'ora di sistema è cambiata in *?<now>* da *< > di data e ora dello snapshot*.<br /><br />Motivo della modifica: modifica dell'ora di un'applicazione o di un componente di sistema.                                                                                                                                   |
|  **16654**   | Directory-Services-SAM  | Un pool di identificatori di account (RID) è stato invalidato. Questa situazione può verificarsi nei seguenti casi previsti:<br /><br />1. il backup viene ripristinato da un controller di dominio.<br /><br />2. un controller di dominio in esecuzione in una macchina virtuale viene ripristinato da uno snapshot.<br /><br />3. un amministratore ha invalidato manualmente il pool.<br /><br />Per ulteriori informazioni, vedere <https://go.microsoft.com/fwlink/?LinkId=226247>. |
...
|--------------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **ID evento** | **Origine** |                                                                                                                                                                                           **Messaggio**                                                                                                                                                                                            |
|   **103**    |   ESENT    |        DFSR (1360) \\\\.\C: \System Volume Information\DFSR\database<em>_<GUID></em>\dfsr.DB: il motore di database ha arrestato l'istanza (0).<br /><br />Chiusura Dirty: 0<br /><br />Sequenza temporale interna: [1] 0.000, [2] 0.000, [3] 0.000, [4] 0.000, [5] 0.141, [6] 0.000, [7] 0.000, [8] 0.000, [9] 0.000, [10] 0.000, [11] 0.016, [12] 0.000, [13] 0.000, [14] 0.000, [15] 0.000.         |
...
|   **105**    |   ESENT    |                                      DFSR (532) \\\\.\C: \System Volume Information\DFSR\database<em>_<GUID></em>\dfsr.DB: il motore di database ha avviato una nuova istanza (0). (Tempo=0 secondi)<br /><br />Sequenza temporale interna: [1] 0.000, [2] 0.000, [3] 0.000, [4] 0.000, [5] 0.000, [6] 0.000, [7] 0.000, [8] 0.000, [9] 0.031, [10] 0.000, [11] 0.000.                                      |
|              |            | DFSR (532) \\\\.\C: \System Volume Information\DFSR\database<em> _<GUID></em>\dfsr.DB: il motore di database ha creato un nuovo database (1, \\\\.\C: \System Volume Information\DFSR\database<em>_ <GUID></em>\dfsr.DB). (Tempo=0 secondi)<br /><br />Sequenza temporale interna: [1] 0.000, [2] 0.000, [3] 0.016, [4] 0.062, [5] 0.000, [6] 0.016, [7] 0.000, [8] 0.000, [9] 0.015, [10] 0.000, [11] 0.000. |
...
|   **1314**   |    Replica DFS    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  Servizio Replica DFS: i file registro di debug sono stati configurati<br /><br />Ulteriori informazioni:<br /><br />Percorso del file di log di debug: C:\Windows\debug                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|   **6102**   |    Replica DFS    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            Il provider WMI è stato registrato in modo corretto.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|   **1206**   |    Replica DFS    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              Il servizio Replica DFS è riuscito a contattare il controller di dominio *<domain controller FQDN>* per accedere alle informazioni di configurazione.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|   **1210**   |    Replica DFS    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    Servizio replica DFS: è stato impostato un listener RPC per le richieste di replica in ingresso.<br /><br />Ulteriori informazioni:<br /><br />Porta: 0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|   **4614**   |    Replica DFS    | Il servizio Replica DFS ha inizializzato SYSVOL nel percorso locale C:\Windows\SYSVOL\domain ed è in attesa di eseguire la replica iniziale. La cartella replicata manterrà lo stato di sincronizzazione iniziale fino al termine della replica con il partner Se era in corso la promozione del server a controller di dominio, il controller di dominio non visualizzerà annunci e non funzionerà come controller di dominio finché il problema non verrà risolto. Questo problema può verificarsi quando anche il partner specificato si trova nello stato di sincronizzazione iniziale oppure quando vengono rilevate violazioni di condivisione nel server o nel partner di sincronizzazione. Se questo evento si è verificato durante la migrazione di SYSVOL dal servizio Replica file (FRS) a Replica DFS, le modifiche non verranno replicate finché il problema non verrà risolto. La cartella SYSVOL di questo server potrebbe non essere sincronizzata con gli altri controller di dominio.<br /><br />Ulteriori informazioni:<br /><br />Nome cartella replicata: condivisione SYSVOL<br /><br />ID cartella replicata: *<GUID>*<br /><br />Nome del gruppo di replica: volume del sistema di dominio<br /><br />ID gruppo di replica: *<GUID>*<br /><br />ID membro: *<GUID>*<br /><br />Sola lettura: 0 |
|   **4604**   |    Replica DFS    |                                                                                                                                                                                                                                                                   Servizio Replica DFS: inizializzazione della cartella replicata SYSVOL nel percorso locale C:\Windows\SYSVOL\domain completata. Questo membro ha completato la sincronizzazione iniziale di SYSVOL con il partner dc1.corp.contoso.com.  Per verificare la presenza della condivisione SYSVOL, aprire una finestra del prompt dei comandi e digitare "net share".<br /><br />Ulteriori informazioni:<br /><br />Nome cartella replicata: condivisione SYSVOL<br /><br />ID cartella replicata: *<GUID>*<br /><br />Nome del gruppo di replica: volume del sistema di dominio<br /><br />ID gruppo di replica: *<GUID>*<br /><br />ID membro: *<GUID>*<br /><br />Partner di sincronizzazione: *<partner domain controller FQDN>*                                                                                                                                                                                                                                                                    |
...
|  **13520**   |   NTFRS    | Il servizio Replica file ha spostato i file preesistenti *<path>* in *<path>* NtFrs_PreExisting___See_EventLog.<br /><br />Il servizio Replica file può eliminare i file in *<path>* \ NtFrs_PreExisting___See_EventLog in qualsiasi momento. È possibile salvare i file dall'eliminazione copiando gli *<path>* NtFrs_PreExisting___See_EventLog. La copia dei file in *<path>* può causare conflitti di nomi se i file sono già presenti in un altro partner di replica.<br /><br />In alcuni casi, il servizio Replica file può copiare un file da *<path>* \ NtFrs_PreExisting___See_EventLog in *<path>* anziché replicare il file da un altro partner di replica.<br /><br />È possibile recuperare spazio in qualsiasi momento eliminando i file in *<path>* \ NtFrs_PreExisting___See_EventLog. |
|  **13553**   |   NTFRS    |                                                                                                                                            Il servizio Replica file ha aggiunto questo computer al seguente insieme di replica:<br /><br />"DOMAIN SYSTEM VOLUME (SYSVOL SHARE)"<br /><br />Le informazioni relative a questo evento vengono mostrate di seguito:<br /><br />Il nome DNS del computer è " *<domain controller FQDN>* "<br /><br />Il nome del membro del set di repliche è " *<domain controller name>* "<br /><br />Il percorso radice dell'insieme di replica è " *<path>* "<br /><br />Il percorso della directory di gestione temporanea della replica è " *<path>* "<br /><br />Il percorso della directory di lavoro della replica è " *<path>* "                                                                                                                                             |
|  **13554**   |   NTFRS    |                                                                                                                                                                                                                     Il servizio Replica file ha aggiunto le seguenti connessioni all'insieme di replica:<br /><br />"DOMAIN SYSTEM VOLUME (SYSVOL SHARE)"<br /><br />In ingresso da " *<partner domain controller FQDN>* "<br /><br />In uscita per " *<partner domain controller FQDN>* "<br /><br />Maggiori informazioni potranno essere visualizzate nei successivi messaggi del registro eventi.                                                                                                                                                                                                                     |
...
|**103**|ESENT|ntfrs (1424) Il motore di database ha arrestato l'istanza (0).<br /><br />Chiusura Dirty: 0<br /><br />Sequenza temporale interna: [1] 0.000, [2] 0.000, [3] 0.000, [4] 0.000, [5] 0.000, [6] 0.000, [7] 0.000, [8] 0.000, [9] 0.031, [10] 0.000, [11] 0.016, [12] 0.000, [13] 0.000, [14] 0.047, [15] 0.000.|  
...
|**103**|ESENT|ntfrs (3000) Il motore di database ha arrestato l'istanza (0).<br /><br />Chiusura Dirty: 0<br /><br />Sequenza temporale interna: [1] 0.000, [2] 0.000, [3] 0.000, [4] 0.000, [5] 0.000, [6] 0.000, [7] 0.000, [8] 0.000, [9] 0.000, [10] 0.000, [11] 0.000, [12] 0.000, [13] 0.015, [14] 0.000, [15] 0.000.|  
|**102**|ESENT|ntfrs (3000) Il motore di database (6.02.8189.0000) sta avviando una nuova istanza (0).|  
...
|**103**|ESENT|ntfrs (3000) Il motore di database ha arrestato l'istanza (0).<br /><br />Chiusura Dirty: 0<br /><br />Sequenza temporale interna: [1] 0.000, [2] 0.000, [3] 0.000, [4] 0.000, [5] 0.078, [6] 0.000, [7] 0.000, [8] 0.000, [9] 0.125, [10] 0.016, [11] 0.000, [12] 0.000, [13] 0.000, [14] 0.000, [15] 0.000.|  
|**102**|ESENT|ntfrs (3000) Il motore di database (6.02.8189.0000) sta avviando una nuova istanza (0).|  

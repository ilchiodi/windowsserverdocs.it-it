...
|        **Origine**        |                                                                                                               Microsoft-Windows-ActiveDirectory_DomainService                                                                                                               |
|       **Gravità**       |                                                                                                                                    Errore                                                                                                                                    |
|       **Messaggio**        | Active Directory ha rilevato che la macchina virtuale che ospita il controller di dominio è stata ripristinata a uno stato precedente. *<COMPUTERNAME>* non è stato possibile eseguire la replica per aggiornare il controller di dominio. Il controller di dominio verrà aggiornato dopo la prossima replica periodica. |
...
|        **Origine**        |                                                       Microsoft-Windows-ActiveDirectory_DomainService                                                       |
|       **Gravità**       |                                                                        Informativo                                                                        |
|       **Messaggio**        |                        *<COMPUTERNAME>* il pool RID corrente è stato invalidato dopo il ripristino dello stato precedente del controller di dominio virtuale.                        |
...
|        **Origine**        |                                                                     Microsoft-Windows-ActiveDirectory_DomainService                                                                     |
|       **Gravità**       |                                                                                          ERRORE                                                                                          |
|       **Messaggio**        | Impossibile ripristinare *<COMPUTERNAME>* dopo il ripristino dello stato precedente del controller di dominio virtuale. Riavviare il sistema in DSRM. Per ulteriori informazioni, controllare gli eventi precedenti. |
...
|        **Origine**        |                                                                                                                                         Microsoft-Windows-ActiveDirectory_DomainService                                                                                                                                         |
|       **Gravità**       |                                                                                                                                                          Informativo                                                                                                                                                          |
|       **Messaggio**        |                                                                                                            *<COMPUTERNAME>* ha eliminato i database DFSR per inizializzare la replica SYSVOL durante un ripristino non autorevole.                                                                                                             |
...
|--------------|-------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **ID evento** |       **Origine**        |                                                                                                                                                                                                       **Messaggio**                                                                                                                                                                                                       |
|    **1**     |     Kernel-General      |                                                                                                                                   L'ora di sistema è cambiata in *? <now>* da *< > di data e ora dello snapshot*.<br /><br />Motivo modifica: Un'applicazione o un componente del sistema ha modificato l'ora.                                                                                                                                   |
...
|--------------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **ID evento** | **Origine** |                                                                                                                                                                                           **Messaggio**                                                                                                                                                                                            |
|   **103**    |   ESENT    |        DFSR (1360) \\ @ no__t-1. \ C: \System Volume Information\DFSR\database @ no__t-2_ @ no__t-3 @ no__t-4\dfsr.DB: Il motore di database ha arrestato l'istanza (0).<br /><br />Arresto anomalo: 0<br /><br />Sequenza temporale interna: [1] 0.000, [2] 0.000, [3] 0.000, [4] 0.000, [5] 0.141, [6] 0.000, [7] 0.000, [8] 0.000, [9] 0.000, [10] 0.000, [11] 0.016, [12] 0.000, [13] 0.000, [14] 0.000, [15] 0.000.         |
|   **102**    |   ESENT    |                                                                                                                    DFSR (532) \\ @ no__t-1. \ C: \System Volume Information\DFSR\database @ no__t-2_ @ no__t-3 @ no__t-4\dfsr.DB: Il motore di database (6.02.8189.0000) sta avviando una nuova istanza (0).                                                                                                                    |
|   **105**    |   ESENT    |                                      DFSR (532) \\ @ no__t-1. \ C: \System Volume Information\DFSR\database @ no__t-2_ @ no__t-3 @ no__t-4\dfsr.DB: Il motore di database ha avviato una nuova istanza (0). (Tempo=0 secondi)<br /><br />Sequenza temporale interna: [1] 0.000, [2] 0.000, [3] 0.000, [4] 0.000, [5] 0.000, [6] 0.000, [7] 0.000, [8] 0.000, [9] 0.031, [10] 0.000, [11] 0.000.                                      |
|              |            | DFSR (532) \\ @ no__t-1. \ C: \System Volume Information\DFSR\database @ no__t-2 @ no__t-3 @ no__t-4 @ no__t-5\dfsr.DB: Il motore di database ha creato un nuovo database (1, \\ @ no__t-1. \ C: \System Volume Information\DFSR\database @ no__t-2 @ no__t-3 @ no__t-4 @ no__t-5\dfsr.DB). (Tempo=0 secondi)<br /><br />Sequenza temporale interna: [1] 0.000, [2] 0.000, [3] 0.016, [4] 0.062, [5] 0.000, [6] 0.016, [7] 0.000, [8] 0.000, [9] 0.015, [10] 0.000, [11] 0.000. |
...
|   **1210**   |    Replica DFS    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    Servizio replica DFS: è stato impostato un listener RPC per le richieste di replica in ingresso.<br /><br />Ulteriori informazioni:<br /><br />Port: 0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|   **4614**   |    Replica DFS    | Il servizio Replica DFS ha inizializzato SYSVOL nel percorso locale C:\Windows\SYSVOL\domain ed è in attesa di eseguire la replica iniziale. La cartella replicata manterrà lo stato di sincronizzazione iniziale fino al termine della replica con il partner Se era in corso la promozione del server a controller di dominio, il controller di dominio non visualizzerà annunci e non funzionerà come controller di dominio finché il problema non verrà risolto. Questo problema può verificarsi quando anche il partner specificato si trova nello stato di sincronizzazione iniziale oppure quando vengono rilevate violazioni di condivisione nel server o nel partner di sincronizzazione. Se questo evento si è verificato durante la migrazione di SYSVOL dal servizio Replica file (FRS) a Replica DFS, le modifiche non verranno replicate finché il problema non verrà risolto. La cartella SYSVOL di questo server potrebbe non essere sincronizzata con gli altri controller di dominio.<br /><br />Ulteriori informazioni:<br /><br />Nome cartella replicata: SYSVOL Share<br /><br />ID cartella replicata: *<GUID>*<br /><br />Nome gruppo di replica: Domain System Volume<br /><br />ID gruppo di replica: *<GUID>*<br /><br />ID membro: *<GUID>*<br /><br />Sola lettura: 0 |
|   **4604**   |    Replica DFS    |                                                                                                                                                                                                                                                                   Servizio Replica DFS: inizializzazione della cartella replicata SYSVOL nel percorso locale C:\Windows\SYSVOL\domain completata. Questo membro ha completato la sincronizzazione iniziale di SYSVOL con il partner dc1.corp.contoso.com.  Per verificare la presenza della condivisione SYSVOL, aprire una finestra del prompt dei comandi e digitare "net share".<br /><br />Ulteriori informazioni:<br /><br />Nome cartella replicata: SYSVOL Share<br /><br />ID cartella replicata: *<GUID>*<br /><br />Nome gruppo di replica: Domain System Volume<br /><br />ID gruppo di replica: *<GUID>*<br /><br />ID membro: *<GUID>*<br /><br />Partner di sincronizzazione: *<partner domain controller FQDN>*                                                                                                                                                                                                                                                                    |
...
|  **13520**   |   NTFRS    | Il servizio Replica file ha spostato i file preesistenti in *<path>* in *<path>* \NtFrs_PreExisting___See_EventLog.<br /><br />Il servizio Replica file può eliminare i file in *<path>* \NtFrs_PreExisting___See_EventLog in qualsiasi momento. I file possono essere salvati dall'eliminazione copiando *<path>* \NtFrs_PreExisting___See_EventLog. La copia dei file in *<path>* può causare conflitti di nomi se i file esistono già in un altro partner di replica.<br /><br />In alcuni casi, il servizio Replica file può copiare un file da *<path>* \NtFrs_PreExisting___See_EventLog in *<path>* anziché replicare il file da un altro partner di replica.<br /><br />È possibile recuperare spazio in qualsiasi momento eliminando i file in *<path>* \NtFrs_PreExisting___See_EventLog. |

...
### <a name="create-an-ad-ds-forest-root-domain-with-windows-powershell"></a><a name="BKMK_PS"></a>Creare un dominio radice della foresta di servizi di dominio Active Directory con Windows PowerShell  

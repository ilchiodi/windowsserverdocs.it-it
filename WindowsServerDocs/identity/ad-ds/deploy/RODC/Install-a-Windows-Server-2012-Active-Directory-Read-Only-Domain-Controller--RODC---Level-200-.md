...
In caso contrario, verrà visualizzato l'errore "Impossibile installare un controller di dominio di sola lettura in questo dominio perché non è ancora stato eseguito il comando "adprep /rodcprep"".  

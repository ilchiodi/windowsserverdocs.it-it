...
ms.locfileid: "71369613"
---
# <a name="windows-server-active-directory-schema-updates"></a>Aggiornamenti dello schema di Windows Server Active Directory

>Si applica a: Windows Server

Questo argomento elenca i file LDF che includono le modifiche apportate da Adprep. exe.  

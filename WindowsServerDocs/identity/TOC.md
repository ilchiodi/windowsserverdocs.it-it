...
##### [Distribuire i criteri di accesso centrale (procedura dimostrativa)](solution-guides/Deploy-a-Central-Access-Policy--Demonstration-Steps-.md)
#### [Scenario: File Access Auditing](solution-guides/Scenario--File-Access-Auditing.md)
##### [Pianificazione del controllo dell'accesso ai file](solution-guides/Plan-for-File-Access-Auditing.md)
##### [Distribuzione dei controlli di sicurezza con criteri di accesso centrale (procedura dimostrativa)](solution-guides/Deploy-Security-Auditing-with-Central-Audit-Policies--Demonstration-Steps-.md)
...
### [Attività iniziali di Active Directory Domain Services](ad-ds/AD-DS-Getting-started.md)
...
###### [Active Directory in esecuzione in macchine virtuali di Azure](ad-ds/deploy/virtual-dc/adds-on-azure-vm.md)
...
###### [Appendice: Riferimento tecnico ai controller di dominio virtualizzati](ad-ds/reference/virtual-dc/Virtualized-Domain-Controller-Technical-Reference-appendix.md)
...
####### [Zone DNS integrate in ActiveDirectory](ad-ds/plan/active-directory-Integrated-DNS-Zones.md)
...
##### [Creazione di una progettazione di unità organizzativa](ad-ds/plan/Creating-an-Organizational-Unit-Design.md)
...
##### [Risorse aggiuntive per la progettazione di una struttura logica](ad-ds/plan/finding-additional-Resources-for-Logical-Structure-Design.md)
...
##### [Risorse aggiuntive per abilitare le funzionalità avanzate](ad-ds/plan/finding-additional-Resources-for-Enabling-Advanced-Features.md)
...
#### [Novità nelle procedure di installazione e rimozione di Active Directory Domain Services](ad-ds/deploy/What-s-New-in-active-directory-Domain-Services-Installation-and-removal.md)
...
##### [Installare una foresta Active Directory di Windows Server](ad-ds/deploy/Install-a-New-Windows-Server-2012-active-directory-forest--Level-200-.md)
...
##### [Pulizia dei metadati di AD DS](ad-ds/deploy/ad-ds-metadata-cleanup.md)
...
##### [Monitoraggio di Active Directory per l'individuazione di segnali di compromissione](ad-ds/plan/security-best-practices/Monitoring-active-directory-for-Signs-of-compromise.md)
...
##### [Appendice H: Protezione degli account Administrator locali e i gruppi](ad-ds/plan/security-best-practices/appendix-H--Securing-Local-Administrator-Accounts-and-Groups.md)
##### [Appendice I: Creazione di account di gestione per gli account protetti e i gruppi in Active Directory](ad-ds/manage/component-updates/appendix-I--Creating-Management-Accounts-for-Protected-Accounts-and-Groups-in-active-directory.md)
...
###### [Identificare gli obiettivi di distribuzione di ADFS](ad-fs/design/Identify-Your-AD-FS-Deployment-Goals.md)
...
###### [Requisiti per ADFS](ad-fs/design/AD-FS-Requirements.md)
...
###### [Mapping degli obiettivi di distribuzione a una progettazione ADFS](ad-fs/design/Mapping-Your-Deployment-Goals-to-an-AD-FS-Design.md)
####### [Soluzione di accesso Single Sign-On Web](ad-fs/design/Web-SSO-Design.md)
####### [Progetto SSO Web federativo](ad-fs/design/Federated-Web-SSO-Design.md)
###### [Determinare la topologia di distribuzione di ADFS](ad-fs/design/Determine-Your-AD-FS-Deployment-Topology.md)
####### [Considerazioni sulla topologia di distribuzione di ADFS](ad-fs/design/AD-FS-Deployment-Topology-Considerations.md)
...
####### [Utilizzo di attestazioni Active Directory Domain Services con ADFS](ad-fs/design/Using-AD-DS-Claims-with-AD-FS.md)
####### [Procedure consigliate per la pianificazione e la distribuzione sicure di ADFS](ad-fs/design/Best-Practices-for-Secure-Planning-and-Deployment-of-AD-FS.md)
...
######## [Preparazione dei computer client nel partner account](ad-fs/design/Prepare-Client-computers-in-the-Account-Partner.md)
...
###### [Pianificazione del posizionamento del server federativo](ad-fs/design/Planning-Federation-Server-Placement.md)
...
####### [Requisiti di risoluzione dei nomi per i server federativi](ad-fs/design/Name-Resolution-Requirements-for-Federation-Servers.md)
###### [Pianificazione del posizionamento del proxy server federativo](ad-fs/design/Planning-Federation-Server-Proxy-Placement.md)
...
###### [Pianificazione della capacità per i server ADFS](ad-fs/design/Planning-for-AD-FS-Server-Capacity.md)
...
###### [Appendice A: Verifica dei requisiti di ADFS](ad-fs/design/appendix-A--Reviewing-AD-FS-Requirements.md)
...
#### [Distribuire Azure AD Connect Health per monitorare l'infrastruttura locale dell'identità nel cloud](https://azure.microsoft.com/documentation/articles/active-directory-aadconnect-health)


#### [Guida alla distribuzione di AD FS in Windows Server 2016 e 2012 R2](ad-fs/deployment/Windows-Server-2012-R2-AD-FS-Deployment-Guide.md)
##### [Distribuzione di una server farm di federazione](ad-fs/deployment/Deploying-a-Federation-Server-Farm.md)
###### [Aggiungere un computer a un dominio](ad-fs/deployment/Join-a-computer-to-a-Domain.md)
###### [Registrare un certificato SSL per ADFS](ad-fs/deployment/Enroll-an-SSL-Certificate-for-AD-FS.md)
###### [Installare il servizio ruolo ADFS](ad-fs/deployment/Install-the-AD-FS-Role-Service.md)
...
###### [Configurare DNS aziendale per il servizio federativo e il servizio DRS](ad-fs/deployment/Configure-Corporate-DNS-for-the-Federation-Service-and-DRS.md)
...
##### [Elenco di controllo: Implementazione di un progetto Web SSO](ad-fs/deployment/Checklist--Implementing-a-Web-SSO-Design.md)
##### [Elenco di controllo: Implementazione di un progetto Web SSO federativo](ad-fs/deployment/Checklist--Implementing-a-Federated-Web-SSO-Design.md)
...
###### [Creare un'attendibilità del provider di attestazioni tramite i metadati federativi](ad-fs/operations/create-a-Claims-Provider-Trust.md)
###### [Creare un trust della relying party con i metadati federativi](ad-fs/operations/create-a-Relying-Party-Trust.md)
...
##### [Configurazione delle regole attestazioni](ad-fs/deployment/Configuring-Claim-Rules.md)
...
###### [Elenco di controllo: creazione di regole attestazione per un trust della relying party](ad-fs/deployment/Checklist--Creating-Claim-Rules-for-a-Relying-Party-Trust.md)
...
###### [Creare una regola per l'invio di un'attestazione compatibile di AD FS 1. x](ad-fs/operations/create-a-Rule-to-Send-an-AD-FS-1x-compatible-Claim.md)
...
###### [Creare una regola per l'invio di un'attestazione di metodo di autenticazione](ad-fs/operations/create-a-Rule-to-Send-an-Authentication-Method-Claim.md)
...
###### [Configurare manualmente un account del servizio per una server farm federativa](ad-fs/deployment/Manually-Configure-a-Service-Account-for-a-Federation-Server-Farm.md)
...
###### [Aggiungere un certificato di decrittografia token](ad-fs/deployment/add-a-Token-Decrypting-Certificate.md)
###### [Impostare un certificato per le comunicazioni di servizi](ad-fs/deployment/Set-a-Service-Communications-Certificate.md)
###### [Verificare che un server federativo sia operativo](ad-fs/deployment/verify-That-a-Federation-Server-Is-Operational.md)
...
###### [Elenco di controllo: configurazione di ADFS per utilizzare attestazioni ADFS 1. x](ad-fs/deployment/Checklist--Configuring-AD-FS--to-Consume-Claims-from-AD-FS-1.x.md)
###### [Elenco di controllo: configurazione di ADFS per l'invio di attestazioni a un servizio federativo di AD FS 1. x](ad-fs/deployment/Checklist--Configuring-AD-FS-to-Send-Claims-to-an-AD-FS-1.x-Federation-Service.md)
###### [Elenco di controllo: configurazione di ADFS per l'invio di attestazioni a un agente Web in grado di riconoscere attestazioni AD FS 1. x](ad-fs/deployment/Checklist--Configuring-AD-FS-to-Send-Claims-to-an-AD-FS-1.x-Claims-Aware-Web-Agent.md)
###### [Creare manualmente un trust della relying party](ad-fs/operations/create-a-Relying-Party-Trust.md)
###### [Creare manualmente un'attendibilità del provider di attestazioni](ad-fs/operations/create-a-Claims-Provider-Trust.md)
###### [Creare una regola per l'invio di un'attestazione compatibile di AD FS 1. x](ad-fs/operations/create-a-Rule-to-Send-an-AD-FS-1x-compatible-Claim.md)
#### [Distribuire Azure AD Connect Health](https://azure.microsoft.com/documentation/articles/active-directory-aadconnect-health/)
#### [Eseguire la migrazione di servizi ruolo di Active Directory Federation Services a Windows Server 2012 R2](ad-fs/deployment/migrate-ad-fs-service-role-to-windows-server-r2.md)
##### [Preparare la migrazione al server federativo di AD FS](ad-fs/deployment/prepare-migrate-ad-fs-server-r2.md)
#####[Eseguire la migrazione al server federativo di AD FS](ad-fs/deployment/migrate-ad-fs-fed-server-r2.md)
#####[Eseguire la migrazione del proxy del server federativo di AD FS](ad-fs/deployment/migrate-fed-server-proxy-r2.md)
...
##### [Preparare la migrazione del server federativo AD FS 2.0](ad-fs/deployment/prepare-to-migrate-ad-fs-fed-server.md)
######[Preparare la migrazione del server federativo autonomo con topologia AD FS 2.0 o server farm a nodo singolo](ad-fs/deployment/prepare-to-migrate-a-stand-alone-ad-fs-federation-server.md)
######[Preparare la migrazione della farm del database interno di Windows AD FS 2.0](ad-fs/deployment/prepare-to-migrate-a-wid-farm.md)
######[Preparare la migrazione della farm di SQL AD FS 2.0](ad-fs/deployment/prepare-to-migrate-a-sql-server-farm.md)
#####[Preparare la migrazione del proxy server federativo AD FS 2.0](ad-fs/deployment/prepare-to-migrate-ad-fs-fed-proxy.md)
#####[Eseguire la migrazione del server federativo AD FS 2.0](ad-fs/deployment/migrate-the-ad-fs-fed-server.md)
######[Eseguire la migrazione del server federativo autonomo con topologia AD FS 2.0 o server farm a nodo singolo](ad-fs/deployment/migrate-ad-fs-stand-alone-server.md)
######[Eseguire la migrazione della farm del database interno di Windows AD FS 2.0](ad-fs/deployment/migrate-ad-fs-wid-farm.md)
######[Eseguire la migrazione della farm di SQL AD FS 2.0](ad-fs/deployment/migrate-ad-fs-sql-farm.md)
#####[Eseguire la migrazione del proxy del server federativo AD FS 2.0](ad-fs/deployment/migrate-the-ad-fs-2-fed-server-proxy.md)
#####[Eseguire la migrazione di agenti Web AD FS 1.1](ad-fs/deployment/migrate-the-ad-fs-web-agent.md)
...
#### [Creare un'applicazione client nativa utilizzando client pubblici OAuth con AD FS](ad-fs/development/native-client-with-ad-fs.md)


### [Operazioni di AD FS](ad-fs/AD-FS-Operations.md)
#### [Criteri di controllo degli accessi di AD FS](ad-fs/operations/AD-FS-Client-Access-Policies.md)
##### [Criteri di controllo degli accessi in AD FS per Windows Server 2016](ad-fs/operations/Access-Control-Policies-in-AD-FS.md)
##### [Criteri di controllo degli accessi in AD FS per Windows Server 2012 R2](ad-fs/operations/Access-Control-Policies-W2K12.md)
##### [Criteri di controllo degli accessi in AD FS 2.0](ad-fs/operations/Access-Control-Policies-in-AD-FS-2.md)
#### [Metodi di autenticazione aggiuntivi in AD FS 2019](ad-fs/operations/Additional-Authentication-Methods-AD-FS.md)
#### [Supporto del parametro di accesso del prompt AD FS](ad-fs/operations/AD-FS-Prompt-Login.md)
...
#### [Configurare le regole di attestazione](ad-fs/operations/Configure-Claim-Rules.md) 
...
#### [Creare un'attendibilità del provider di attestazioni](ad-fs/operations/create-a-Claims-Provider-Trust.md) 
#### [Creazione di un'attendibilità della relying party non in grado di riconoscere attestazioni](ad-fs/operations/create-a-Non-Claims-Aware-Relying-Party-Trust.md)
#### [Creare un'attendibilità della relying party](ad-fs/operations/create-a-Relying-Party-Trust.md) 
...
#### [Delegare l'accesso Commandlet di Powershell AD FS agli utenti non amministratori](ad-fs/operations/delegate-ad-fs-pshell-access.md)
...
#### [Accedere a una rete aziendale da qualsiasi dispositivo per usare funzionalità SSO e di autenticazione a due fattori trasparente per tutte le applicazioni aziendali](ad-fs/operations/Join-to-Workplace-from-Any-Device-for-SSO-and-Seamless-Second-Factor-Authentication-Across-company-Applications.md)
#### [Gestire i rischi con meccanismi Multi-Factor Authentication aggiuntivi per le applicazioni con esigenze particolari](ad-fs/operations/Manage-Risk-with-additional-Multi-Factor-Authentication-for-Sensitive-Applications.md)
...
#### [Impostare un ambiente lab per AD FS](ad-fs/operations/Set-up-an-AD-FS-lab-environment.md)
#### [Guida allo scenario: Gestire i rischi con meccanismi di autenticazione a più fattori aggiuntivi per le applicazioni con esigenze particolari](ad-fs/operations/Walkthrough-Guide--Manage-Risk-with-additional-Multi-Factor-Authentication-for-Sensitive-Applications.md)
...
#### [Procedura dettagliata: Workplace Join con un dispositivo Android](ad-fs/operations/Walkthrough--Workplace-Join-to-an-Android-device.md)
...
#### [Informazioni sulle proprietà AD FS e KeySpec del certificato](ad-fs/technical-reference/AD-FS-and-KeySpec-Property.md)
...
##### [Ruolo delle regole attestazioni](ad-fs/technical-reference/The-Role-of-Claim-Rules.md)
##### [Ruolo del motore delle attestazioni](ad-fs/technical-reference/The-Role-of-the-Claims-Engine.md)
##### [Ruolo delle pipeline delle attestazioni](ad-fs/technical-reference/The-Role-of-the-Claims-Pipeline.md)
##### [Ruolo del linguaggio delle regole attestazioni](ad-fs/technical-reference/The-Role-of-the-Claim-Rule-Language.md)
##### [Determinare il tipo di modello di regole attestazioni da usare](ad-fs/technical-reference/Determine-the-type-of-Claim-Rule-Template-to-Use.md)
...
### [Panoramica tecnica dei criteri di restrizione software](software-restriction-policies/software-restriction-policies-technical-overview.md)

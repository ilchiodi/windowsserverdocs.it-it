...
Per informazioni sulla creazione di account utente e di gruppo in Active Directory (AD), vedere [https://technet.microsoft.com/library/cc783323%28v.aspx](https://technet.microsoft.com/library/cc783323%28v=ws.10%29.aspx).
...
Per un video, vedere [Active Directory Federation Services serie di video illustrativi: Installazione di una server farm](https://technet.microsoft.com/video/dn469436)ad FS.
...
5.  Per configurare il funzionamento di **claimapp** con il server federativo eseguire le operazioni seguenti:
    ...
    3.  Selezionare **Usa un STS esistente** e passare all'URL dei metadati del server di ad FS **https://adfs1.contoso.com/federationmetadata/2007-06/federationmetadata.xml** . Fare clic su **Avanti**.

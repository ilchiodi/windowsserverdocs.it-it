...
## <a name="software-requirements"></a><a name="BKMK_3"></a>Requisiti software  
Di seguito sono riportati i requisiti di AD FS per la funzionalità server di incorporata nel sistema operativo Windows Server&reg; 2012 R2:  
  
-   Per l'accesso Extranet, è necessario distribuire il servizio ruolo Proxy applicazione Web \- parte del ruolo server di accesso remoto di Windows Server&reg; 2012 R2. Le versioni precedenti di un proxy server federativo non sono supportate con AD FS in Windows Server&reg; 2012 R2.  
...
## <a name="extranet-requirements"></a><a name="BKMK_extranet"></a>Requisiti Extranet  
...
Per informazioni sulla configurazione del DNS aziendale per i proxy dell'applicazione Web, vedere la sezione "configurare DNS" in [passaggio 1: configurare l'infrastruttura del proxy dell'applicazione Web](https://technet.microsoft.com/library/dn383644.aspx).  
...
## <a name="attribute-store-requirements"></a><a name="BKMK_8"></a>Requisiti dell'archivio attributi  
...
## <a name="application-requirements"></a><a name="BKMK_9"></a>Requisiti delle applicazioni  
...
## <a name="authentication-requirements"></a><a name="BKMK_10"></a>Requisiti di autenticazione  
...
## <a name="workplace-join-requirements"></a><a name="BKMK_11"></a>Requisiti per l'aggiunta all'area di lavoro  
...
## <a name="cryptography-requirements"></a><a name="BKMK_12"></a>Requisiti di crittografia  

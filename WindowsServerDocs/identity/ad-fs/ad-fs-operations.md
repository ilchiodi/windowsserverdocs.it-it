...
title: Operazioni di AD FS 2016
description: ''
author: billmath
ms.author: billmath
manager: femila
...
ms.locfileid: "67316350"
---
# <a name="ad-fs-operations"></a>Operazioni di AD FS



Questo documento contiene un elenco di tutte le operazioni di documentazione per AD FS per Windows Server 2016. Tali attributi includono:  
...
- [Impostazioni di Single Sign-On di AD FS 2016](../ad-fs/operations/AD-FS-2016-Single-Sign-On-Settings.md)
...
- [Aggiungere un attributo di Store](../ad-fs/operations/Add-an-Attribute-Store.md)
...
- [Configurare AD FS 2016 e Azure MFA](../ad-fs/operations/Configure-AD-FS-2016-and-Azure-MFA.md)
...
- [Configurare ADFS per l'autenticazione del certificato utente](../ad-fs/operations/Configure-User-Certificate-Authentication.md)
...
- [Personalizzare intestazioni della risposta HTTP protezione con AD FS 2019](../ad-fs/operations/customize-http-security-headers-ad-fs.md)
...
- [Gestione dei certificati SSL in AD FS e WAP 2016](../ad-fs/operations/Manage-SSL-Certificates-AD-FS-WAP-2016.md)
- [Configurare un ambiente lab per AD FS](../ad-fs/operations/Set-up-an-AD-FS-lab-environment.md)
- [SQL correttamente l'ottimizzazione e la risoluzione di latenza](../ad-fs/operations/adfs-sql-latency.md) 
- [Procedura dettagliata: Gestire i rischi con l'autenticazione a più fattori aggiuntiva per le applicazioni sensibili](../ad-fs/operations/Walkthrough-Guide--Manage-Risk-with-Additional-Multi-Factor-Authentication-for-Sensitive-Applications.md)

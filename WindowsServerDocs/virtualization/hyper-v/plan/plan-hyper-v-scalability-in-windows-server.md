...
|-------------|-----------|---------|  
|Punti di controllo|50|Il numero effettivo potrebbe essere inferiore in base allo spazio di archiviazione disponibile. Ogni checkpoint viene archiviato come file con estensione avhd che usa l'archiviazione fisica.|  
...
|Component|Massimo|Note|  
|-------------|-----------|---------|  
|Processori logici|512|Entrambi devono essere abilitati nel firmware:<p>-Virtualizzazione assistita da hardware<br />-Protezione esecuzione programmi applicata dall'hardware<p>Il sistema operativo host (partizione radice) visualizzerà solo i processori logici massimi 320|  

...
##  <a name="basic-features-of-the-dashboard"></a><a name="BKMK_Design"></a>Funzionalità di base del dashboard  
 Il dashboard di Windows Server Essentials consente di accedere rapidamente alle principali informazioni e alle funzionalità di gestione del server. Il dashboard include diverse sezioni. La tabella seguente descrive le sezioni.  
  
 
  
|Elemento|Funzionalità del dashboard|Descrizione|  
|----------|-----------------------|-----------------|  
...
|4|Riquadro dettagli|Il riquadro dei dettagli visualizza altre informazioni sull'oggetto selezionato nella visualizzazione elenco.|  
|5|Riquadro attività|Il riquadro attività contiene i collegamenti agli strumenti e alle informazioni che consentono di gestire le proprietà di un oggetto specifico, ad esempio un account utente o un computer, o le impostazioni globali della categoria di oggetti. Il riquadro attività è diviso nelle due sezioni seguenti:<br /><br /> **Attività oggetto** œ contiene i collegamenti agli strumenti e alle informazioni che consentono di gestire le proprietà di un oggetto selezionato nella visualizzazione elenco, ad esempio un account utente o un computer.<br /><br /> **Attività globali** œ contiene i collegamenti agli strumenti e alle informazioni che consentono di gestire le attività globali per un'area funzionale. Le attività globali includono attività per aggiungere nuovi oggetti, impostare criteri e così via.|  
...
##  <a name="features-of-the-dashboard-home-page"></a><a name="BKMK_Home"></a>Funzionalità della Home page del dashboard  
...
|4|Action pane|Questo riquadro fornisce una breve descrizione di una funzionalità o di un'attività e fornisce i collegamenti che aprono le procedure guidate di configurazione e le pagine informative. Fare clic su un collegamento per eseguire un'ulteriore azione.|  
  
##  <a name="administrative-sections-of-the-dashboard"></a><a name="BKMK_Features"></a>Sezioni amministrative del dashboard  
...
|Sezione|Descrizione|  
|-------------|-----------------|  
|Home|La pagina **Home** viene visualizzata per impostazione predefinita ogni volta che si apre il dashboard. Include attività e informazioni delle categorie seguenti:<br /><br /> **Installazione** œ completare le attività di questa categoria per configurare il server per la prima volta. Per informazioni su queste attività, vedere [installare e configurare Windows Server Essentials](../install/Install-and-Configure-Windows-Server-Essentials.md).<br /><br /> **Email** œ scegliere un'opzione in questa categoria per integrare un servizio di posta elettronica con il server.<br /><br /> **Nota:** Questa categoria è disponibile solo in Windows Server Essentials.<br /><br /> **Services** œ scegliere un'attività in questa categoria per integrare Microsoft servizi online con il server.<br /><br /> **Nota:** Questa categoria è disponibile solo in Windows Server Essentials e Windows Server 2012 R2 Standard con il ruolo esperienza Windows Server Essentials abilitato.<br /><br /> **Componenti** aggiuntivi œ fare clic su questa categoria per installare componenti aggiuntivi importanti per l'azienda.<br /><br /> **Stato rapido** œ Visualizza lo stato del server di alto livello. Fare clic su uno stato per visualizzare informazioni e opzioni di configurazione per la funzionalità corrispondente. Se si completano tutte le attività della categoria CONFIGURAZIONE, questa categoria viene visualizzata nella parte superiore del riquadro Categoria.<br /><br /> **Help** œ utilizzare la casella di ricerca per cercare la guida sul Web. Fare clic su un collegamento per visitare il sito Web corrispondente all'opzione di supporto selezionata.|  
|Utenti|Per consentire agli utenti di accedere alle risorse fornite da Windows Server Essentials, è necessario creare gli account utente tramite il dashboard di Windows Server Essentials. Dopo aver creato gli account utente, è possibile gestirli con le attività disponibili nella pagina **Utenti** del dashboard. Le attività che è possibile eseguire in questa pagina includono:<br /><br /> -Visualizzare un elenco di account utente.<br /><br /> -Visualizzare e gestire le proprietà dell'account utente.<br /><br /> -Attivare o disattivare gli account utente.<br /><br /> -Aggiungere o rimuovere account utente.<br /><br /> -Assegnare gli account di rete locali agli account Microsoft Servizi online se il server è integrato con Office 365.<br /><br /> -Modificare le password degli account utente e gestire i criteri password.<br /><br /> Per informazioni sulla gestione degli account utente, vedere [gestire gli account utente](Manage-User-Accounts-in-Windows-Server-Essentials.md).|  
|Gruppi di utenti|**Nota:** Questa funzionalità è disponibile solo in Windows Server Essentials e Windows Server 2012 R2 Standard con il ruolo esperienza Windows Server Essentials abilitato.<br /><br /> Le attività che è possibile eseguire in questa pagina includono:<br /><br /> -Visualizzare un elenco di gruppi di utenti.<br /><br /> -Visualizzare e gestire i gruppi di utenti.<br /><br /> -Aggiungere o rimuovere gruppi di utenti.|  
|Gruppi di distribuzione|**Nota:** Questa funzionalità è disponibile solo in Windows Server Essentials e Windows Server 2012 R2 Standard con il ruolo esperienza Windows Server Essentials abilitato. Questa scheda viene visualizzata solo se Windows Server Essentials è integrato con Office 365.<br /><br /> Le attività che è possibile eseguire in questa pagina includono:<br /><br /> -Visualizzare un elenco di gruppi di distribuzione.<br /><br /> -Aggiungere o rimuovere gruppi di distribuzione.|  
|Dispositivi|Dopo aver connesso i computer alla rete di Windows Server Essentials, è possibile gestirli dalla pagina **Dispositivi** del dashboard. Le attività che è possibile eseguire in questa pagina includono:<br /><br /> -Visualizzare un elenco di computer aggiunti alla rete.<br /><br /> -Gestire i dispositivi mobili sfruttando la funzionalità di gestione dei dispositivi mobili di Office 365.<br /><br /> **Nota:** Questa funzionalità è disponibile solo in Windows Server Essentials e Windows Server 2012 R2 Standard con il ruolo esperienza Windows Server Essentials abilitato.<br /><br /> -Visualizzare le proprietà del computer e gli avvisi di integrità per ogni computer.<br /><br /> -Configurare e gestire i backup dei computer.<br /><br /> -Ripristinare file e cartelle nei computer.<br /><br /> -Stabilire una connessione Desktop remoto a un computer<br /><br /> -Personalizzare le impostazioni di backup del computer e cronologia file<br /><br /> Per informazioni sulla gestione di computer e backup, vedere [gestire i dispositivi](Manage-Devices-in-Windows-Server-Essentials.md).|  

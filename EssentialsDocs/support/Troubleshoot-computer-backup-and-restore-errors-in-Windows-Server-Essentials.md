...
3.  Rimuovere il computer dal dominio. Per altre informazioni, vedere [Remove a computer from a Windows domain](../use/Get-Connected-in-Windows-Server-Essentials.md#BKMK_8).  
